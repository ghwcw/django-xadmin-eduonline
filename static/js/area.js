...
var provinceObjectDiv = ''
    + '<div>'
    + '<div class="dizhi_t">'
    + '  <div class="dizhi_t_1"><p class="hover" idx="1">省份</p><p idx="2">城市</p><p idx="3">区县</p><p idx="4">清空</p></div>'
    + '  <div class="province">'
    + '   <div class="dizhi_t_2">'
    + '     <div class="dizhi_t_2_1">A-G</div>'
    + '     <div class="dizhi_t_2_2"><P>安徽</P><P>澳门</P><P>北京</P><P>重庆</P><P>福建</P><P>甘肃</P><P>广东</P><P>广西</P><P>贵州</P>'
    + '     </div>'
    + '   </div>'
    + '   <div class="dizhi_t_2">'
    + '     <div class="dizhi_t_2_1">H-K</div>'
    + '     <div class="dizhi_t_2_2"><P>海南</P><P>河北</P><P>河南</P><P>黑龙江</P><P>湖北</P><P>湖南</P><P>吉林</P><P>江苏</P><P>江西</P>'
    + '     </div>'
    + '   </div>'
    + '   <div class="dizhi_t_2">'
    + '     <div class="dizhi_t_2_1">L-S</div>'
    + '     <div class="dizhi_t_2_2"><P>辽宁</P><P>内蒙古</P><P>宁夏</P><P>青海</P><P>山东</P><P>山西</P><P>陕西</P><P>上海</P><P>四川</P>'
    + '     </div>'
    + '   </div>'
    + '   <div class="dizhi_t_2">'
    + '     <div class="dizhi_t_2_1">T-Z</div>'
    + '     <div class="dizhi_t_2_2"><P>天津</P><P>台湾</P><P>香港</P><P>西藏</P><P>新疆</P><P>云南</P><P>浙江</P>'
    + '     </div>'
    + '   </div>'
    + ' </div>'
    + ' <div class="city" style="display: none;">'
    + '   <div class="dizhi_t_2">'
    + '     <div class="dizhi_t_2_2" style="width:100%;padding-left: 5px;">'
    + '     </div>'
    + '   </div>'
    + ' </div>'
